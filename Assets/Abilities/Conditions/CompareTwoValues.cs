...
public class CompareTwoValues: Condition
{
    ...
    public CompareTwoValues(BattleManager battleManager, Being parentBeing, string conditionName, Being p, string value, string mode, int target) : base(battleManager, parentBeing, conditionName) //This should grab the battleManager from the base constructor (Condition)
    {
        this.p = p;
