...
public class LessThan : Condition
{
    ...
    public LessThan(BattleManager battleManager, Being parentBeing, string conditionName, string mode, Being p, int target) : base(battleManager, parentBeing, conditionName) //This should grab the battleManager from the base constructor (Condition)
    {
        this.mode = mode;
        this.p = p;
    }
