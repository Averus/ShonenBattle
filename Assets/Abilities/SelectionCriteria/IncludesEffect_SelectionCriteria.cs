...
public class IncludesEffect_SelectionCriteria : SelectionCriteria
{
    ...
    public IncludesEffect_SelectionCriteria(BattleManager battleManager, Being parentBeing, string selectionCriteriaName, string effectName) : base(battleManager, parentBeing, selectionCriteriaName)
    {
