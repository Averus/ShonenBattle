...
public class CostsMP : Effect {
    ...
    public CostsMP(BattleManager battleManager, Being parentBeing, Ability parentAbility, String effectName, int cost) : base(battleManager, parentBeing, parentAbility, effectName)
    {
